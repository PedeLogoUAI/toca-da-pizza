...
// Função carregarProdutos atualizada:
        ...
        <div class="produto-direita">
          ...
          <div class="quantity-selector">
            <button class="qty-btn" ${prod.quantidade === 0 ? 'style="visibility: hidden;"' : ''} 
                    onclick="decrementarQuantidade('${categoria}', '${prod.produto}')">
            ...
            <button class="qty-btn" onclick="incrementarQuantidade('${categoria}', '${prod.produto}')">+</button>
          </div>
        </div>
      </div>
    `;
...
// Função carregarSacola atualizada:
