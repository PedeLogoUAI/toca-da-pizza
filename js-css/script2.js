document.addEventListener('DOMContentLoaded', function() {
    ...
    function addToCart(productId) {
        ...
        // Verificar se é pizza para lógica de meio a meio
    ...
    // Adicionar item ao carrinho (lógica comum)
    function addItemToCart(product) {
        ...
        // Atualizar botões "Adicionar" para mostrar quantidade
        if (currentCategory) {
